...
export const faqData: FAQItem[] = [
  {
    ...
    answer:
      "BidSubs is an AI-powered estimating platform built for construction firms. Upload your plans, and our system automatically generates accurate takeoffs, cost estimates, and professional proposals—in minutes, not hours.",
  },
  {
    id: 2,
